    ...
    void Update()
    {
       ...
       // StaminaBarController(nowstamina, maxstamina);
        ...
        if (jumpstate == false)
        {
            if (playermovestate == 1 || playermovestate == 2)
            {
                if (Input.GetKeyDown(KeyCode.LeftShift))//�޸���� ������ȯ
                {
        ...
        if (playermovestate == 2 && nowstamina == 0)//�޸��ٰ� ���¹̳��� 0�̵Ǹ� �ȱ�� �ڵ� ��ȯ
        {
            playermovestate = 1;
        }
        ...
        if (jumpstate == false)
        {
            if (Input.GetKeyDown(KeyCode.LeftControl))//�ɱ� ���� ��ȯ
            {
                if (playermovestate == 1)
                {
                    playermovestate = 3;
